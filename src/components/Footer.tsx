...
const Footer: React.FC = () => {
  return (
    <footer className="w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 bg-green-800 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm sm:text-base">
              ...
              <div className="pt-4">
                <a href="#" className="text-gray-300 hover:text-green-400 transition-colors duration-200 text-sm flex items-center gap-2">
