  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20">
      {/* Container principal com padding e bordas arredondadas */}
        <div 
          className="relative w-full mx-auto rounded-[20px] sm:rounded-[40px] lg:rounded-[70px] overflow-hidden min-h-[700px] lg:min-h-[700px] bg-[url('/bg.jpg')] bg-cover bg-no-repeat p-4 sm:p-6 lg:p-10 flex items-top md:items-end"
        >
